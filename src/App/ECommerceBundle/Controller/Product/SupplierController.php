...
class SupplierController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppECommerceBundle\Product:Supplier')->findAll();
     ...
     * @Method("POST")
     * @Template("AppECommerceBundle\Product:Supplier:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppECommerceBundle\Product:Supplier:edit.html.twig")
     */
