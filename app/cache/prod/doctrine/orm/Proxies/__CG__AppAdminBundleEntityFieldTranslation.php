 ...
 */
class FieldTranslation extends \App\AdminBundle\Entity\FieldTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\AdminBundle\\Entity\\FieldTranslation' . "\0" . 'id', '' . "\0" . 'App\\AdminBundle\\Entity\\FieldTranslation' . "\0" . 'langue', 'object', '' . "\0" . 'App\\AdminBundle\\Entity\\FieldTranslation' . "\0" . 'value');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FieldTranslation $proxy) {
